...
- If you run into trouble:
  ...
  - On "Failure [INSTALL_FAILED_ALREADY_EXISTS]" or "Failure [INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES]" try to find the application. It is probably named "au.com.unimelb.aikuma". If you can't find it, just find anything with "aikuma" in the name.
