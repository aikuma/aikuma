...
public class SegmentTest {
	...
	public void fromHash() {
		Segment loaded = Segment.fromHash((Map<String, Object>) JSONValue
				.parse("{\"id\":\"Some Identifier\"}"));
	...
	@Test
	public void toHash() {
		assertEquals("{\"id\":\"some_identifier\"}",
				JSONValue.toJSONString(segment.toHash()));
	}
	...
	@Test
	public void getSoundfilePath() {
		assertEquals(
				"/Users/admin/temp/eclipse_workspace/BOLDApp/mnt/sdcard/bold/timelines/someTimelineId/segments/some_identifier.3gp",
				segment.getSoundfilePath("someTimelineId"));
	}
